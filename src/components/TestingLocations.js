        ...
        <Container component="main" maxWidth="lg">
            ...
            <div className={classes.paper}>
                <Typography variant="h2" component="h1" gutterBottom>
                    COVID-19 Testing Locations in the US
                </Typography>
                <form className={classes.form} noValidate>
                    <FormControl className={classes.formControl}>
                        ...
                        >
                            {states.map(state => (
                                <MenuItem key={state.name} value={state.name.toLowerCase().replace(/ /g,"-")}>
                                    {state.name}
                                </MenuItem>
                            ))}
                        </Select>
                ...
                {'' !== location && <TestingLocationCard location={locations[location]}/> }
            </div>
        </Container>
    );
}
